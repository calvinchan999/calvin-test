...
@Component({
  selector: 'app-sa-pages-pin',
  templateUrl: './sa-pages-pin.component.html',
  styleUrls: ['./sa-pages-pin.component.scss']
})
export class SaPagesPinComponent implements OnInit {
  isLoading = false
